...
public class NormalMonster : MonoBehaviour
{
    ...
    private void FollowPlayer()
    {
        ...
        {
            // 怪物跟随角色
            //transform.position = Vector2.MoveTowards(new Vector2(transform.position.x, INIT_Y) , new Vector2(target.position.x, INIT_Y), moveSpeed * Time.deltaTime);
